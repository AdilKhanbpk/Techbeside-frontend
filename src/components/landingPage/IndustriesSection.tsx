...
const IndustriesSection = () => {
  return (
    ...
    <div className="max-w-5xl mx-auto text-center">
      <h2 className="text-3xl md:text-4xl lg:text-5xl  font-bold text-indigo-600">Industries we serve</h2>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:mt-9 mt-6">
      {industries.map((industry, index) => (
        <Link key={index} href={industry.link}>
         <div className="p-6 border rounded-xl shadow-sm border-gray-300 bg-gradient-to-r from-indigo-500 to-indigo-500 hover:border-indigo-600 hover:border-2 cursor-pointer flex flex-col justify-between hover:scale-105 transition-transform duration-300 ease-in-out">
