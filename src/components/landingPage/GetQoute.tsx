...
const GetQoute = () => {
  return (
    ...
    Let’s Build Your Next <span className="text-indigo-600">Software</span> Solution
    </h2>
    <Link href="/contact">
      <button className="border p-3 px-7 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white cursor-pointer">
        Get a Quote
      </button>
    </Link>
  </section>  
