...
const Benefits = () => {
  ...
  <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 md:gap-10 md:mt-9 mt-6">
    {features.map((feature, index) => (
      <div
        key={index}
        className="flex flex-col items-center md:p-6 p-2 bg-gradient-to-r from-indigo-500 to-indigo-500 rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:border-indigo-600 hover:border-2"
      >
        {feature.icon}
