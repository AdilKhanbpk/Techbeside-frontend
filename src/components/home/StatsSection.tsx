      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, i) => (
            ...
            >
              <div className="relative p-8 rounded-3xl bg-[#091E36] border border-indigo-500 shadow-lg transition-all group hover:scale-105 hover:shadow-indigo-800/50">
                ...
                <div className="relative space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-end gap-2">
                      <span className="text-5xl font-bold bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">
                        {stat.value}
                      </span>
                      <span className="text-xl text-indigo-400 mb-1.5">+</span>
                    </div>
