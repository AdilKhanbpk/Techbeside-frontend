    ...
    <div className="bg-gray-100 md:p-8 md:mt-16 mt-9 px-3">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-purple-800 text-white p-6 rounded-lg flex flex-col justify-center items-center text-center">
          ...
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=contact@techcreator.co"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 px-4 rounded-lg inline-block cursor-pointer relative z-10"
          >
            Shoot a Direct Mail
          </a>
