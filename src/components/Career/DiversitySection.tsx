    ...
    <div>
      <div className=" mt-9 md:mt-16 mb-9 md:mb-16">
        <div className="max-w-3xl mb-6">
          <h2 className="font-semibold  font-inter mb-4 text-3xl md:text-5xl text-indigo-600">
            We're from everywhere
          </h2>
          <p className="text-[#838696] font-normal font-inter text-[22px] leading-[35px]">
          A TechBeside workplace is more than just a workplace - it's a place where you can grow, innovate, and make an impact. Let's build a culture of excellence, collaboration, and shared purpose together if our values resonate with you. Let's redefine what's possible together.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
         ...
         <Link href="https://www.instagram.com/TechBesideco/" target="_blank" rel="noopener noreferrer">
